    ...
    return (
        <Drawer anchor="left" open={isOpen} onClose={toggleDrawer(false)}>
          ...
          <div className={styles['menu_wrapper']}>
            ...
            <Link to="/Main/Shifts" className={styles['menu_list']}>Мои смены</Link>
            <Link to="/Main/Exchange" className={styles['menu_list']}>Биржа смен</Link>
            {/* <Link to="/Main/Salary" className={styles['menu_list']}>Моя зарплата</Link> */}
            <div className={`${styles.menu_list} ${styles.item_blocked}`}>Моя зарплата</div>
